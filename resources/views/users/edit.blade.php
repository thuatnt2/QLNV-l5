...
<div class="row">
    <div class="box row-form">
        ...
        {!! Former::horizontal_open(action('UserController@update', $user->id))->id('form-changepassword') !!}
        {{ method_field('PUT') }}
        <fieldset>
        {!! Former::legend('Form đổi mật khẩu') !!}
        <div class="col-sm-offset-3 col-sm-4">
            {!! Former::password('now_password', 'Mật khẩu cũ')->required()->addClass('input-sm'); !!}
            {!! Former::password('password', 'Mật khẩu mới')->required()->addClass('input-sm'); !!}
            {!! Former::password('password_confirmation', 'Xác nhận')->required()->addClass('input-sm'); !!}
